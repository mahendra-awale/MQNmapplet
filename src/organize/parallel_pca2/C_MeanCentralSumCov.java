...
/**
 * This is the first actual step of a PCA calculation: The mean centralization. From all MQN values
 * the avg is subtracted (actually to have the value-distribution-gauss around 0. see pca tutorial
 * to see exactly why.)
 * After each mean centralisation the sums required later for the covariance matrix are calculated,
 * these sums are then written out in the .covsums file.
 * Created 09-Nov-2009
 * @author lori
 */
