...
/**
 * ArgReader
 * Provides functions to easily retrieve command line arguments (isArg, getArg)
 * and also takes over displaying of a helptext if user did not provide any arguments at startup
 *
