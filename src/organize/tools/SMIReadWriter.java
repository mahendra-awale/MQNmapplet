...
/**
 * SMIRW: Smiles Reader Writer
 * Opens a file to read (specified with -i NAME at the command line)
 * and a file to write (specified with -o NAME at the command line)
 * It is then possible to read the lines as molecules
 * 
 */
